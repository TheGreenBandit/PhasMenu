...
namespace menu
{
	...
	enum class log_color : std::uint16_t
	{
		...
		fintensify = FOREGROUND_INTENSITY,
		bred = BACKGROUND_RED,
		bgreen = BACKGROUND_GREEN,
		bblue = BACKGROUND_BLUE,
		bintensify = BACKGROUND_INTENSITY
	};
	...
	public:
			...
			m_file(log_file)
		{
			if (m_attach_console)
			{
				...
				if ((m_console_handle = GetStdHandle(STD_OUTPUT_HANDLE)) != nullptr)
				{
					...
					SetLayeredWindowAttributes(GetConsoleWindow(), NULL, 190, LWA_ALPHA);
		...
		struct log_sink
		{
			std::map<std::string, log_color> log_colors = {
				{INFO.text, log_color::fblue | log_color::fintensify/* | log_color::bblue | log_color::bgreen | log_color::bred | log_color::bintensify*/},
				{WARNING.text, log_color::fred/* | log_color::bblue | log_color::bgreen | log_color::bred | log_color::bintensify*/},
				{HACKER.text, log_color::fgreen/* | log_color::fintensify | log_color::bblue | log_color::bgreen | log_color::bred | log_color::bintensify*/},
				{FATAL.text, log_color::fred/* | log_color::fintensify | log_color::bblue | log_color::bgreen | log_color::bred | log_color::bintensify*/},
				{G3LOG_DEBUG.text, log_color::fblue/* | log_color::bblue | log_color::bgreen | log_color::bred | log_color::bintensify*/},
				{RAW_RED.text, log_color::fred/* | log_color::bblue | log_color::bgreen | log_color::bred | log_color::bintensify*/},
				{RAW_GREEN_TO_CONSOLE.text, log_color::fgreen | log_color::fintensify/* | log_color::bblue | log_color::bgreen | log_color::bred | log_color::bintensify*/} };
